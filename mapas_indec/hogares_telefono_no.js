  ...
  var info_hogares_telefono_no = L.control({ position: 'bottomleft' });
  ...
  function getColor_hogares_telefono_no(d) {
    return d >     175    ? '#800026' :
		...
		var legend_hogares_telefono_no = L.control({position: 'topleft'});
  ...
  function resetHighlight_hogares_telefono_no(e) {
    ...
    info_hogares_telefono_no.removeFrom(map)
    info_hogares_telefono_no.update();
    legend_hogares_telefono_no.removeFrom(map);
  }
