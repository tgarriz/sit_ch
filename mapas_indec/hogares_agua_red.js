  ...
  var info_hogares_agua_red = L.control({ position: 'bottomleft' });
  ...
  function getColor_hogares_agua_red(d) {
    return d >     350    ? '#800026' :
		...
		var legend_hogares_agua_red = L.control({position: 'topleft'});
  ...
  function resetHighlight_hogares_agua_red(e) {
    ...
    info_hogares_agua_red.removeFrom(map)
    info_hogares_agua_red.update();
    legend_hogares_agua_red.removeFrom(map);
  }
